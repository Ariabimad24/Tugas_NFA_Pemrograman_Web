...
import { bukuHome, bukuAtomic, bukuDeep, bukuPragmatic } from "../assets";
      ...
      <section style={{ background: "#f8f9fa", padding: "50px 40px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{
            ...
            {[
              { title: "Atomic Habits",          author: "James Clear",   img: bukuAtomic,    desc: "Tiny changes, remarkable results. A guide to building good habits and breaking bad ones." },
              { title: "Deep Work",               author: "Cal Newport",   img: bukuDeep,      desc: "Rules for focused success in a distracted world. Learn to concentrate deeply." },
              { title: "The Pragmatic Programmer", author: "David Thomas", img: bukuPragmatic, desc: "Your journey to mastery. A classic guide for software developers." },
            ].map((book, i) => (
              <div key={i} style={{
                background: "#fff",
                borderRadius: 8,
                ...
                <img src={book.img} alt={book.title} style={{ width: "100%", height: 160, objectFit: "cover" }} />
